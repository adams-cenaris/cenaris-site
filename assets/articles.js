/* Cenaris Insights — article content, keyed by slug.
   Sourced from Adam Stefano's "NDIS Audit Evidence Map (2026 Edition)".
   The article page (insights-article.html) reads ?slug=… from the URL
...
window.CENARIS_ARTICLES = {
  ...
  'policies-vs-systems': {
    ...
    lede: 'An audit-defensible organisation isn\'t necessarily larger or more resourced — it\'s structurally coherent. Here\'s where that distinction shows up, and why it changes the audit experience entirely.',
    ...
    body: `
      ...
      <p>Auditors are not assessing whether you value quality. They are examining whether your organisation can demonstrate control — consistently, traceably, and under scrutiny.</p>
      ...
      <p>Pick a single Core Module standard — Risk Management is a useful one. Now attempt to map it end-to-end:</p>
      <ol>
      ...
      <p>If the answer is no, the gap isn't a missing document. It's a missing link. The <a href="audit-readiness-check.html">audit readiness check</a> takes about two minutes and surfaces those links — or where they are absent — across the four domains.</p>
    `,
  ...
  'structural-model': {
    ...
    body: `
      <p>The NDIS Practice Standards are outcome-based. They describe what must be achieved but leave the structure to you. That sounds like flexibility — in practice, it is where most providers come unstuck.</p>
      ...
      <p>The link from <em>risk</em> to <em>standard</em>. Risks are described well enough in plain language but never mapped to the indicators they actually threaten — so the auditor cannot trace a finding back to a managed risk.</p>
      ...
      <p>If any step in that chain takes more than a minute — or requires a different system, a different person, or a phone call — that's where the model is breaking.</p>
  ...
  'governance-operational': {
    ...
    lede: 'Module 2 catches the most providers — not because documents are missing, but because it tests whether governance is active or symbolic.',
    category: 'Governance',
    tagClass: 'blue',
    date: '14 Apr 2026',
    readTime: '7 min read',
    ...
    body: `
      <p>If there is one module in the NDIS Core that consistently surfaces findings, it is Governance and Operational Management. Not because the domain is unusually difficult, but because it is the structural heart of the whole framework — and structure is what auditors actually examine.</p>
      ...
      <ol>
        <li><strong>Current</strong> — reviewed on a documented cycle, not at audit time.</li>
        <li><strong>Linked</strong> — mapped to the relevant standards and indicators.</li>
        <li><strong>Owned</strong> — assigned to a named person with the authority to act.</li>
        <li><strong>Connected</strong> — informed by incident trends, and linked to corrective actions.</li>
      </ol>
      ...
      <p>Credential verification, supervision frameworks, and training compliance must be demonstrable on request. If generating a training compliance report requires manual collation across multiple spreadsheets, structural fragility exists. Auditors do not need to find a non-compliant worker — they only need to find that you couldn't show you'd know if there was one.</p>

      <h2>Continuous improvement — the closing-loop test.</h2>
      ...
      <h2>Where to start.</h2>
      <p>Pull your risk register and your last four sets of board minutes. Try to find one risk discussion in the minutes that references a specific risk ID, an open corrective action, and an outcome decision. If you cannot, governance is currently being recorded as attendance — not as oversight.</p>
    `,
  ...
  'five-things-auditors-examine': {
    ...
    lede: 'Traceability, currency, sufficiency, risk visibility, and governance oversight — what auditors actually test across every domain, regardless of how good your documents look.',
    category: 'Audit prep',
    tagClass: 'green',
    date: '2 Apr 2026',
    readTime: '5 min read',
    ...
    body: `
      ...
      <p>An auditor must be able to follow a clear path from a standard to its operational control and supporting evidence. Without traceability, even strong documentation reads as disconnected — and the auditor records what they cannot trace, not what is verbally explained.</p>
      ...
      <p>Risks must connect to standards, controls, and incident trends. A risk register that exists but does not surface in governance discussions, corrective actions, and incident reviews is structurally invisible — the auditor's note is "limited risk visibility," not "no register."</p>

      <h2>5. Governance oversight.</h2>
      <p>Leadership must demonstrate active engagement with compliance performance — not periodic attendance at compliance meetings. Board minutes that reference risk IDs, open corrective actions, and trend data evidence oversight. Minutes that record "compliance update noted" do not.</p>

      <blockquote>These are structural properties, not surface attributes. They determine how the audit feels — and how the report reads.</blockquote>

      <h2>A short diagnostic.</h2>
      <p>Take one standard. Score it honestly against the five properties — on a 1-to-4 scale: not established, documented only, systematised and monitored, fully integrated and governed. The scores will tell you, before any auditor arrives, where the next finding is forming.</p>
  ...
  'fragile-vs-defensible': {
    ...
    lede: 'Two providers, both committed, both believe they are compliant. Only one is structurally defensible. The difference is not effort — it is architecture.',
    category: 'Governance',
    tagClass: 'blue',
    date: '21 Mar 2026',
    readTime: '7 min read',
    ...
    body: `
      ...
      <h2>Provider A — document-heavy, structurally fragile.</h2>
      ...
      <h2>Provider B — structurally defensible.</h2>
      ...
      <p>The auditor can follow a clear line: <strong>Standard → Indicator → Control → Evidence → Risk → Governance Review.</strong></p>
      ...
      <h2>Where to start.</h2>
      <p>Open your own risk register and ask the same three questions the auditor asked Provider A. Where the answers depend on verbal explanation, that is where your architecture is currently invisible — and where the next finding sits.</p>
    `,
  ...
  'incident-as-signal': {
    ...
    body: `
      ...
      <p>Every incident is a signal from the operating environment: a control didn't hold, or a process produced an outcome it shouldn't have. The point of the log isn't to remember the incident — it's to ask the system a question and read the answer. A mature structure does more than log; it identifies themes, monitors response timeframes, evaluates root causes, and records the systemic change that followed.</p>

      <h2>The structural test — three connections.</h2>
      <p>An incident log earns its place in the compliance architecture only when three connections exist:</p>
      <ol>
        <li><strong>Incident → Control.</strong> Every incident is linked to the operational control that was tested. Without this link, you cannot tell which controls are weakening.</li>
        <li><strong>Incident → Risk.</strong> Trends and serious events feed enterprise risk ratings on a documented cycle — not as a one-off after an event, but as a rhythm.</li>
        <li><strong>Incident → Corrective Action → Governance.</strong> Where an incident triggers a corrective action, the action is verified before closure, and the lesson is surfaced to leadership with evidence that the change held.</li>
      </ol>
      ...
      <p>Try this: ask your team to produce a twelve-month complaint or incident trend report in under thirty minutes, with a paragraph on what changed in the organisation as a result of those trends. If they can't — or the answer is a count without a change — the issue is not the log. It is the integration.</p>
      ...
      <h2>Where to start.</h2>
      <p>Pull the last six months of incidents into a single sheet. Sort by category, then by site. Watch the mix, not just the total. Drift is almost always visible before any individual incident escalates — but only if someone is reading the log as a system, not a stack of forms.</p>
    `,
  ...
  'document-to-system': {
    ...
    lede: 'You don\'t need to discard what you have. You need to make the links between what you have visible — one standard at a time.',
    category: 'Quality',
    tagClass: 'sand',
    date: '22 Feb 2026',
    readTime: '9 min read',
    ...
    body: `
      ...
      <h2>Step 1 — Map one standard end-to-end.</h2>
      ...
      <p>Do not improve anything yet. Simply map what exists. The exercise reveals the fragmentation — and where the fragmentation is, is where to focus.</p>

      <h2>Step 2 — Establish traceable linkage.</h2>
      ...
      <h2>Step 3 — Formalise review rhythms.</h2>
      <p>Document clear review cycles for the risk register, incident trend analysis, training compliance, policy review, and corrective action verification. Governance oversight should follow these rhythms rather than ad hoc reporting. Structure reduces reliance on memory and goodwill — both of which fail under audit conditions.</p>

      <h2>Step 4 — Eliminate duplication.</h2>
      ...
      <h2>Step 5 — Move from reactive to proactive monitoring.</h2>
      <p>Instead of preparing for audit annually, design systems that continuously flag overdue reviews, highlight open corrective actions, surface high-risk categories, and detect outdated evidence. Compliance becomes part of operational rhythm rather than a periodic event — and the cost curve flattens.</p>

      <h2>Step 6 — Elevate governance visibility.</h2>
      ...
      <h2>Where to start.</h2>
      <p>Pick the standard you have the most confidence in. Run Step 1 on it. If the mapping exercise is harder than expected, that is the most useful data point of the quarter — and the start of the transition.</p>
    `,
  ...
  'rights-responsibilities': {
    ...
    lede: 'This domain is not satisfied by aspirational language. Auditors test whether protections function in real time — through visibility, responsiveness, and oversight.',
    category: 'NDIS Standards',
    tagClass: 'sand',
    date: '12 Feb 2026',
    readTime: '6 min read',
    ...
    body: `
      ...
      <p>A consent process that is documented is necessary — but not sufficient. Auditors will sample a participant file and ask: was consent obtained, recorded, and revisited at the right intervals? Is it accessible in a format the participant could understand?</p>
      <p>Complaints are similar. The register exists. The question is whether it is live, whether response timeframes are defined, whether categories are tracked, and whether outcomes are documented — not just recorded.</p>

      <h2>Beyond logging — the analysis chain.</h2>
      ...
      <blockquote>Participant protection is demonstrated through visibility, responsiveness, and oversight — not through the existence of the policy that describes it.</blockquote>

      <h2>The 12-month trend diagnostic.</h2>
      <p>Here is a simple internal test that reveals structural maturity. Ask your team to generate a twelve-month complaint trend report in under thirty minutes, and to describe — in a paragraph — what changed in the organisation as a result of those complaints.</p>
  ...
  'provision-of-supports': {
    ...
    lede: 'Less frequently audited deeply than Module 2 — but when corrective actions land here, they tend to be operational and disruptive. The trap is uncontrolled variation.',
    category: 'Quality',
    tagClass: 'sand',
    date: '28 Jan 2026',
    readTime: '5 min read',
    ...
    body: `
      <p>The Provision of Supports domain evaluates whether services are delivered consistently and safely. It is less frequently the source of major findings than Governance — but when it is, the corrective actions tend to be operational and disruptive.</p>

      <h2>Service agreements and individualised plans.</h2>
      <p>Auditors examine whether service agreements are clear and current, whether individualised plans are implemented and reviewed, and whether documentation standards are consistent across teams. Inconsistency between sites is one of the most common observations in this module — and it is rarely caused by intention.</p>
      ...
      <p>Supervision and clinical oversight mechanisms must be demonstrable. Inconsistent documentation across practitioners or sites is a common exposure point. Variation may be clinically appropriate — different participants, different supports — but uncontrolled variation indicates system weakness. The distinction the auditor cares about is whether the variation is explainable.</p>
  ...
  'support-environment': {
    ...
    body: `
      ...
      <ol>
        <li><strong>The current emergency management plan</strong> — and the date of the last review.</li>
        ...
        <li><strong>The equipment maintenance schedule</strong> — and evidence the schedule is being followed, not just maintained as a document.</li>
      </ol>
